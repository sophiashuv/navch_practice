...
//Завдання 1.
//Розробити типи для обслуговування читачiв у бiблiотечному абонементi.
//Читач характеризується iменем, прiзвищем та реєстрацiйним номером. Книга характеризується
//облiковим номером, автором книги, назвою книгиi жанром. Замовлення характеризується датою,
//облiковим номером книги,реєстрацiйним номером читача та ознакою виконання(так-нi).
//Iнформацiяпро читачiв та книги подана окремими файлами. Замовлення також поданокiлькома окремими файлами.
//Отримати:
...
//        2. рейтинг читачiв за загальною кiлькiстю замовлених книг у форматi
